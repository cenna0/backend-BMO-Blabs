...
|---|---|---|
| Backend tests | Node 22.23.1: 47 files passed, 1 skipped; 239 tests passed, 1 skipped DB HTTP suite. Slice 2B account/profile/recovery/avatar/personalization plus deterministic lock/reconciliation interleaving coverage is included | Disposable-Postgres authenticated HTTP acceptance remains separately opt-in and was not run |
