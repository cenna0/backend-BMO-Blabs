...
**Status:** `PROPOSED — CAPACITY GATE REQUIRED`
...
| PostgreSQL | start with conservative shared buffers/work_mem and one private instance | DB restart/load/restore |
...
The exact container numbers are OPEN until P9.1 measures the live deployment.
